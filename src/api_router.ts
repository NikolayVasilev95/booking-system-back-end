...
router.get("/positions", allPositionsController);
...
router.get("/employees", allEmployeesController);
...
router.get("/services", allServicesController);
...
router.get("/schedules", allSchedulesController);
...
router.get("/salons", allSalonsController);
...
router.get("/calendars", allCalendarsController);
