...
import {
  ...
  getEmployee,
  allEmployees,
} from "../../database/operations/employees";
import { CustomRequest } from "./types";

const newEmployeeController = async (
...
const getEmployeeController = async (
  request: CustomRequest,
  response: Response
) => {
...
const allEmployeesController = async (
  request: CustomRequest,
  response: Response
) => {
  console.log("AHA!!", request.query);
